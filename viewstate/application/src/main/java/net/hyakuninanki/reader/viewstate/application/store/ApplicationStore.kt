...
package net.hyakuninanki.reader.viewstate.application.store

import androidx.lifecycle.LiveData
import androidx.lifecycle.MutableLiveData
import net.hyakuninanki.reader.viewstate.application.action.StartApplicationAction
import net.hyakuninanki.reader.viewstate.core.Dispatcher
import net.hyakuninanki.reader.viewstate.core.Event
import net.hyakuninanki.reader.viewstate.core.Store
