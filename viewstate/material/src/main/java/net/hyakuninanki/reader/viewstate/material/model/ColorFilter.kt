...
package net.hyakuninanki.reader.viewstate.material.model

import android.content.res.Resources
import androidx.annotation.StringRes
import net.hyakuninanki.reader.domain.karuta.model.KarutaColor
import net.hyakuninanki.reader.viewstate.material.R
...
enum class ColorFilter(
    ...
    fun label(res: Resources): String = res.getString(resId)
