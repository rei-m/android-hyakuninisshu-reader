...
class ToriFudaView
    ...
    constructor(
        ...
        init {
            ...
            val padding = resources.getDimensionPixelOffset(net.hyakuninanki.reader.feature.corecomponent.R.dimen.spacing_0_5)
            ...
            context.withStyledAttributes(attrs, R.styleable.FudaView) {
                val testSize = getResourceId(R.styleable.FudaView_textSize, net.hyakuninanki.reader.feature.corecomponent.R.dimen.text_m)
