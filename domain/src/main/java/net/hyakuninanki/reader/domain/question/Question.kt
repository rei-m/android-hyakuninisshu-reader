...
class Question private constructor(
    ...
    fun verify(choiceNo: ChoiceNo, answerDate: Date): Question {
        ...
        val judgement = QuestionJudgement(correctNo, correctNo == selectedNo)
        this.result = QuestionResult(choiceNo, answerTime, judgement)
        return this
    }
    ...
    companion object {
        fun createReady(
            ...
            correctNo: KarutaNo
        ) = Question(id, choiceList, correctNo)
        ...
        fun createInAnswer(
            ...
            correctNo: KarutaNo,
            startDate: Date
        ) = Question(id, choiceList, correctNo, startDate)
        ...
        fun createAnswered(
            ...
            val judgement = QuestionJudgement(correctNo, isCorrect)
            ...
            return Question(id, choiceList, correctNo, startDate, result)
        }
    }
}
